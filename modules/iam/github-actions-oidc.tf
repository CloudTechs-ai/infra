...
data "aws_iam_policy_document" "github_actions_assume_role" {
  statement {
    ...
    condition {
      ...
      values = [
        "repo:${var.github_org}@295695252/frontend@1386538577:ref:refs/heads/main",
        "repo:${var.github_org}@295695252/frontend@1386538577:ref:refs/heads/develop",
        "repo:${var.github_org}@295695252/frontend@1386538577:ref:refs/heads/test-ci",

        "repo:${var.github_org}@295695252/backend@1386538997:ref:refs/heads/main",
        "repo:${var.github_org}@295695252/backend@1386538997:ref:refs/heads/develop",
      ]
    }
  }
}
